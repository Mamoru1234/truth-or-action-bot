...
name = 'sessionMigration1678892927668'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('CREATE TABLE "chat_session_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "type" character varying NOT NULL, "tgId" character varying NOT NULL, CONSTRAINT "PK_fae0fb01a1927d2351c04719901" PRIMARY KEY ("id"))');
