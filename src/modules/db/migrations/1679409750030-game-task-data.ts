  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    const query = queryRunner.connection
      ...
      .values([
        ...
        {
          type: GameTaskType.Action,
          text: 'Сходи до сусіда й попроси в нього цукру та картоплі.',
        },
        {
          type: GameTaskType.Truth,
          text: 'Якщо ти матимеш можливість здійснити три бажання, що проситимеш?',
        },
        {
          type: GameTaskType.Action,
          text: 'Відправ повідомлення будь-якому хлопцю з текстом: "Колян, то де ж пивас?"',
        },
        {
          type: GameTaskType.Truth,
          text: 'Якою найнепотрібнішою справою ти займався(-лась) на роботі?',
        },
        {
          type: GameTaskType.Action,
          text: 'Покажи без слів що хочеш купити трьох слонів і одного зайця в подарунок другу.',
        },
        {
          type: GameTaskType.Truth,
          text: 'Чи здійснював(-ла) ти божевільні вчинки напідпитку? Якщо так то які саме?',
        },
        {
          type: GameTaskType.Action,
          text: 'Стань струнко, поклади руку на груди й гордо виконай перші 2 рядки гімну України',
        },
        {
          type: GameTaskType.Truth,
          text: 'Маєш можливість вибрати для себе суперсилу. Що обереш?',
        },
        {
          type: GameTaskType.Action,
          text: 'Протягом наступних 5 хвилин тобі пострібно вести себе, як марцьовий кіт.',
        },
        {
          type: GameTaskType.Truth,
          text: 'Яке слово, на твою думку, потрібно заборонити?',
        },
        {
          type: GameTaskType.Action,
          text: 'Гравці кладуть на стілець будь-який предмет. Ти поивнен(-на) із заплющеними очима, вийнятково п`ятою точкою, визначити що це.',
        },
        {
          type: GameTaskType.Truth,
          text: 'Яким має бути твій ідеальний день?',
        },
        {
          type: GameTaskType.Action,
          text: 'Говори незрозумілою мовою до кінця гри. Спробуй зробити так, щоб гравці тебе зрозуміли.',
        },
        {
          type: GameTaskType.Truth,
          text: 'Чи доводилося тобі жертвувати дружбою заради чогось або когось?',
        },
        {
          type: GameTaskType.Action,
          text: 'Постав на аватарку в соцмережі фото гравця, який сидить праворуч.',
        },
        {
          type: GameTaskType.Truth,
